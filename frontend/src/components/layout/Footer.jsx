...
export default function Footer() {
    return (
        <footer className="border-t-2 border-t-brand-gold/30 mt-24 bg-foreground text-background">
            {/* Signature brand row */}
            <div className="border-b border-white/10">
                <div className="container-page py-8 flex items-center justify-between flex-wrap gap-6">
                    <ITHRLockup size={52} className="text-background" />
                    <div className="flex items-center gap-6 text-xs font-mono uppercase tracking-[0.2em] text-white/60">
            ...
            <div className="container-page py-14 grid grid-cols-2 md:grid-cols-5 gap-10">
                <div className="col-span-2">
                    <p className="text-sm text-white/70 leading-relaxed max-w-md">
                        The Enterprise Agentic AI Academy is designed, curated, and continuously refreshed by <span className="text-white">ITHR Technologies Consulting LLC</span>. Trusted by Fortune 500 workforces to master autonomous AI systems.
                    </p>
                </div>

                <div>
                    <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-gold mb-4">Learn</div>
                ...
                <div>
                    <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-gold mb-4">Enterprise</div>
                    <ul className="space-y-2 text-sm text-white/80">
                ...
                <div>
                    <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-gold mb-4">ITHR</div>
            ...
            <div className="border-t border-white/10">
                <div className="container-page py-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-3 text-xs text-white/50">
